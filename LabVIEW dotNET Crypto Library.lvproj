...
<Project Type="Project" LVVersion="21008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Unit Tests" Type="Folder">
			<Item Name="TestAES.lvclass" Type="LVClass" URL="../Unit Tests/TestAES/TestAES.lvclass"/>
			<Item Name="TestdotNetStreams.lvclass" Type="LVClass" URL="../Unit Tests/TestdotNetStreams/TestdotNetStreams.lvclass"/>
			<Item Name="TestHashing.lvclass" Type="LVClass" URL="../Unit Tests/TestHashing/TestHashing.lvclass"/>
			<Item Name="TestPBKDF2.lvclass" Type="LVClass" URL="../Unit Tests/TestPBKDF2/TestPBKDF2.lvclass"/>
			<Item Name="TestHexStringConversion.lvclass" Type="LVClass" URL="../Unit Tests/TestHexStringConversion/TestHexStringConversion.lvclass"/>
			<Item Name="TestRSA.lvclass" Type="LVClass" URL="../Unit Tests/TestRSA/TestRSA.lvclass"/>
		</Item>
		<Item Name="Playground" Type="Folder">
			<Item Name="dotNET Constructor Map.vi" Type="VI" URL="../Source Code/Playground/dotNET Constructor Map.vi"/>
		</Item>
		<Item Name="Examples" Type="Folder">
			<Item Name="dotNET Key Management Testing.vi" Type="VI" URL="../Source Code/Examples/dotNET Key Management Testing.vi"/>
			<Item Name="dotNET Crypto Demonstrator.vi" Type="VI" URL="../Source Code/Examples/dotNET Crypto Demonstrator.vi"/>
			<Item Name="Ephemeral RSA Testing.vi" Type="VI" URL="../Source Code/Examples/Ephemeral RSA Testing.vi"/>
			<Item Name="Asymmetric RSA Key Testing.vi" Type="VI" URL="../Source Code/Examples/Asymmetric RSA Key Testing.vi"/>
			<Item Name="TPM RSA Encryption Example.vi" Type="VI" URL="../Source Code/Examples/TPM RSA Encryption Example.vi"/>
		</Item>
		<Item Name="dotNET Crypto Asymmetric Encryption.lvlib" Type="Library" URL="../Source Code/Asymmetric Encryption/dotNET Crypto Asymmetric Encryption.lvlib"/>
		<Item Name="dotNET Crypto Hashing.lvlib" Type="Library" URL="../Source Code/Hashing/dotNET Crypto Hashing.lvlib"/>
		<Item Name="dotNET Crypto RNG.lvlib" Type="Library" URL="../Source Code/Random Number Generation/dotNET Crypto RNG.lvlib"/>
		<Item Name="dotNET Crypto Symmetric Encryption.lvlib" Type="Library" URL="../Source Code/Symmetric Encryption/dotNET Crypto Symmetric Encryption.lvlib"/>
		<Item Name="dotNET Crypto Utility.lvlib" Type="Library" URL="../Source Code/Utility/dotNET Crypto Utility.lvlib"/>
		<Item Name="dotNET Crypto Key Derivation.lvlib" Type="Library" URL="../Source Code/Key Derivation/dotNET Crypto Key Derivation.lvlib"/>
		<Item Name="dotNET Crypto Key Management.lvlib" Type="Library" URL="../Source Code/Key Management/dotNET Crypto Key Management.lvlib"/>
