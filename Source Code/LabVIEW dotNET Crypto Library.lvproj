...
<Project Type="Project" LVVersion="21008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Playground" Type="Folder">
			<Item Name="dotNET Constructor Map.vi" Type="VI" URL="../Playground/dotNET Constructor Map.vi"/>
		</Item>
		<Item Name="Examples" Type="Folder">
			<Item Name="dotNET Key Management Testing.vi" Type="VI" URL="../Key Management/dotNET Key Management Testing.vi"/>
			<Item Name="dotNET Crypto Demonstrator.vi" Type="VI" URL="../Playground/dotNET Crypto Demonstrator.vi"/>
			<Item Name="Ephemeral RSA Testing.vi" Type="VI" URL="../Playground/Ephemeral RSA Testing.vi"/>
			<Item Name="Asymmetric RSA Key Testing.vi" Type="VI" URL="../Playground/Asymmetric RSA Key Testing.vi"/>
			<Item Name="TPM RSA Encryption Example.vi" Type="VI" URL="../Playground/TPM RSA Encryption Example.vi"/>
		</Item>
		<Item Name="dotNET Crypto Asymmetric Encryption.lvlib" Type="Library" URL="../Asymmetric Encryption/dotNET Crypto Asymmetric Encryption.lvlib"/>
		<Item Name="dotNET Crypto Hashing.lvlib" Type="Library" URL="../Hashing/dotNET Crypto Hashing.lvlib"/>
		<Item Name="dotNET Crypto RNG.lvlib" Type="Library" URL="../Random Number Generation/dotNET Crypto RNG.lvlib"/>
		<Item Name="dotNET Crypto Symmetric Encryption.lvlib" Type="Library" URL="../Symmetric Encryption/dotNET Crypto Symmetric Encryption.lvlib"/>
		<Item Name="dotNET Crypto Utility.lvlib" Type="Library" URL="../Utility/dotNET Crypto Utility.lvlib"/>
		<Item Name="dotNET Crypto Key Derivation.lvlib" Type="Library" URL="../Key Derivation/dotNET Crypto Key Derivation.lvlib"/>
		<Item Name="dotNET Crypto Key Management.lvlib" Type="Library" URL="../Key Management/dotNET Crypto Key Management.lvlib"/>
